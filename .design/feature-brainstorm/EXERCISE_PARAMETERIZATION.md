...
- **1125 entries**: the 1-5 ordinal rating (§2) for 72 machine/cable/smith exercises × 28 brands (988 entries) plus 137 free-weight/bodyweight/kettlebell exercises (one rating each, no brand). Only 2 exercises skipped (Power Clean, Hang Clean — ballistic multi-phase lifts, no single curve-shape judgment applies), both with stated reasons.
